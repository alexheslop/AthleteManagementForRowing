...
namespace AthleteManagementTools.Model
{
    ...
    internal class SQLDatabaseComms
    {
        ...
        public static ObservableCollection<Rower> SelectSquad(string squad, string side, string sort)
        {
            const string datastring =
                "SELECT FirstName,LastName,Squad,Side,CanScull,BowsideRank,StrokesideRank,ScullRank,PB2k,PB5k,PB30r20,UT2Split,MaxHR,MinHR,Injured FROM Athletes";
        ...
        private static ObservableCollection<Rower> ReadAthleteDatabase(string sqlQuery)
        {
            ...
            {
                DataSource = "alexfirstserver.database.windows.net",
                UserID = "aheslop",
                Password = "120gbHDD#",
                InitialCatalog = "MyDatabase"
            };

            using (var sqlConnection = new SqlConnection(conBuilder.ConnectionString))
            {
                sqlConnection.Open();
                ...
                {
                    CommandText =
                        "SELECT BoatName,Seats,Cox,Scull,classRank FROM Boats"
                };
        ...
        public static bool WritePersonToDatabase(string firstName, string lastName, string squad, string side,
            bool canScull,
            int bowsideRank, int strokesideRank, int scullRank, string pb2K, string pb5K, string pb30R20,
            string ut2Split)
        {
            var conBuilder = new SqlConnectionStringBuilder
            {
        ...
        public static bool UpdateRowerFromErgProfile(string firstName, string lastName, string pb2K, string pb5K,
            string pb30R20, string ut2Split, int maxHr, int minHr)
        {
